...
API_JIRA_USERS = "https://moengagetrial.atlassian.net/rest/api/3/user?key={user_key}"
API_JIRA_USERS_ACCOUNTID = "https://moengagetrial.atlassian.net/rest/api/3/user?accountId={account_id}"
